...
reticulate::use_python(Sys.which("/Users/liubov/miniconda3/bin/python"), required=TRUE)
library(reticulate)
library(survival)
library(survminer)
library(factoextra)
...
The estimation of the number of sample clusters "k" in the dataset (so the "factorization rank") is a challenging problem. Again, it is recommended to run the method for a broad range of possible "k" values and compare the robustness of resulting clusters. For this purpose SUMO implements two metrics:

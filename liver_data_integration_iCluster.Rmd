...
```{r}
# Load data, leave only primary tumor samples:
...
```
So, we see that our separation is not the same at all as the existing data for iCluster subtypes. But, we do not know which data they integrated.
